...
Sistema desktop desenvolvido em C# Windows Forms para gerenciamento e cadastro de clientes
...
- ✅ **Cadastro de Clientes** - Adicione novas bandas com informações completas
- 🔍 **Busca de Clientes** - Pesquise bandas cadastradas
- 📝 **Alteração de Clientes** - Edite informações de bandas existentes
- 🗑️ **Remoção de Clientes** - Exclua registros do sistema
- 🎵 **Gerenciamento de Clientes** - Adicione novos gêneros musicais
